...
var routes = [
    { path: '', component: _country_country_component__WEBPACK_IMPORTED_MODULE_3__["CountryComponent"] },
...
var CountryService = /** @class */ (function () {
    function CountryService(httpClient) {
        ...
        this.apiUrl = 'https://rku5krhh6d.execute-api.us-west-2.amazonaws.com/Prod/api';
    }
    CountryService.prototype.loadCountries = function () {
        return this.httpClient.get(this.apiUrl + '/countries').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    // Error handling
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvdW50cnkvY291bnRyeS5jb21wb25lbnQuY3NzIn0= */"
...
var CountryComponent = /** @class */ (function () {
    ...
    CountryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.countries = [];
        this.subscription = this.service.loadCountries().subscribe(function (x) { return _this.loadCountries(x); });
    };
    ...
    CountryComponent.prototype.loadCountries = function (countries) {
        var _a;
        console.log(countries);
        (_a = this.countries).push.apply(_a, countries);
    };
...
module.exports = __webpack_require__(/*! D:\country_Demo\contryWebApp\src\main.ts */"./src/main.ts");
